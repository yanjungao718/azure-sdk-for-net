...
namespace Azure.AI.MetricsAdvisor.Administration
{
    ...
    [CodeGenSuppress(nameof(DataSourceDataLakeSharedKey), typeof(string), typeof(DataLakeGen2SharedKeyParam))]
    public partial class DataSourceDataLakeSharedKey
    {
        private string _accountKey;

        /// <summary>
        /// Initializes a new instance of the <see cref="DataSourceDataLakeSharedKey"/> class.
        /// </summary>
        /// <param name="name">A custom unique name for this <see cref="DataSourceDataLakeSharedKey"/> to be displayed on the web portal.</param>
        /// <param name="accountKey">The account key to be used for authentication.</param>
        public DataSourceDataLakeSharedKey(string name, string accountKey)
            : base(name)
        {
        ...
        internal DataSourceDataLakeSharedKey(DataSourceCredentialType dataSourceCredentialType, string id, string name, string description, DataLakeGen2SharedKeyParam parameters)

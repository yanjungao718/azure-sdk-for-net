...
namespace Azure.AI.MetricsAdvisor
{
    ...
    public partial class MetricChangePointFeedback : MetricFeedback
    {
        ...
        public MetricChangePointFeedback(string metricId, DimensionKey dimensionKey, DateTimeOffset startTime, DateTimeOffset endTime, ChangePointValue value) : base(metricId, dimensionKey)
        {
            if (value == default)
            {
        ...
        internal MetricChangePointFeedback(string metricId, GetAllFeedbackFilter dimensionFilter, DateTimeOffset startTime, DateTimeOffset endTime, ChangePointFeedbackValue value) : base(metricId, dimensionFilter)
        {

...
namespace Azure.AI.MetricsAdvisor.Models
{
    ...
    public partial class AnomalyAlertConfiguration
    {
        ...
        internal AnomalyAlertConfiguration(string id, string name, string description, DetectionConditionOperator? crossMetricsOperator, IList<string> dimensionsToSplitAlert, IList<string> idsOfHooksToAlert, IList<MetricAlertConfiguration> metricAlertConfigurations)
        {
            Id = id;
            Name = name;

...
{
    public partial class DataSourceDataLakeSharedKey : IUtf8JsonSerializable
    {
        ...
        internal static DataSourceDataLakeSharedKey DeserializeDataSourceDataLakeSharedKey(JsonElement element)
        {
            ...
            return new DataSourceDataLakeSharedKey(dataSourceCredentialType, dataSourceCredentialId.Value, dataSourceCredentialName, dataSourceCredentialDescription.Value, parameters);
        }
    }
}

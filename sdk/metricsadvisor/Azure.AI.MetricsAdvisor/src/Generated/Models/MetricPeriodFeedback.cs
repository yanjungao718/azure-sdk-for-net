...
namespace Azure.AI.MetricsAdvisor
{
    ...
    public partial class MetricPeriodFeedback : MetricFeedback
    {
        ...
        internal MetricPeriodFeedback(MetricFeedbackKind kind, string id, DateTimeOffset? createdTime, string userPrincipal, string metricId, GetAllFeedbackFilter dimensionFilter, PeriodFeedbackValue valueInternal) : base(kind, id, createdTime, userPrincipal, metricId, dimensionFilter)
        {
